...
DB_FEEDS = [
    "https://www.bhaskar.com/rss-feed/4356/",  # Crime
    "https://www.bhaskar.com/rss-feed/1061/",  # National
]

_SOURCE_ID = uuid.UUID("00000000-0000-0000-0000-000000000008")


class DainikBhaskarAdapter(BaseAdapter):
    ...
    def fetch(self) -> list[RawArticlePayload]:
        ...
        for feed_url in DB_FEEDS:
            try:
                ...
                logger.error("dainik_bhaskar_feed_error", feed=feed_url, error=str(exc))
