...
PTI_FEEDS = [
    "https://www.ptinews.com/rss/crime.xml",
    "https://www.ptinews.com/rss/india.xml",
]

_SOURCE_ID = uuid.UUID("00000000-0000-0000-0000-000000000002")
    ...
    def fetch(self) -> list[RawArticlePayload]:
        ...
        for feed_url in PTI_FEEDS:
            try:
                    ...
                    try:
                        ...
                        if resp.status_code == 200:
                            ...
                            article_div = (
                                ...
                                or soup.find("div", class_="article-text")
                ...
                logger.error("pti_feed_error", feed=feed_url, error=str(exc))
